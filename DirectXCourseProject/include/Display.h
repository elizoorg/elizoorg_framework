...
public:
  ...
  DECLARE_MULTICAST_DELEGATE(OnKeyDownDelegate,
                             InputDevice::KeyboardInputEventArgs);
  OnKeyDownDelegate OnKeyDown;

private:
  static LRESULT CALLBACK WndProcStatic(HWND hwnd, UINT umessage, WPARAM wparam,
                                        LPARAM lparam);
