...
class ENGINE_API TriangleComponent : public GameComponent {
private:
  ...
  DirectX::XMFLOAT4 points[8] = {
      Vector4(-3.0f, 3.0f, -3.0f, 1.0f),  Vector4(3.0f, 3.0f, -3.0f, 1.0f),
      Vector4(-3.0f, -3.0f, -3.0f, 1.0f), Vector4(3.0f, -3.0f, -3.0f, 1.0f),
      Vector4(-3.0f, 3.0f, 3.0f, 1.0f),   Vector4(3.0f, 3.0f, 3.0f, 1.0f),
      Vector4(-3.0f, -3.0f, 3.0f, 1.0f),  Vector4(3.0f, -3.0f, 3.0f, 1.0f)};
...
public:
  TriangleComponent(Engine::Application *app)
      : GameComponent(app){
